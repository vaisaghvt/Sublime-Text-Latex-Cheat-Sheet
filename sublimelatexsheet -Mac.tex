...
\begin{center}
     \Large{\textbf{\LaTeX\ Sublime Papers2 Cheat Sheet (For Mac)}} \\
\end{center}
...
\verb!cmd+shift+t!      & Reopen last closed file \\
...
\verb!ctrl+cmd++p!       & Open Project from recent list (if no papers installed)\\
\verb!cmd+w!       & Close current file\\
\verb!cmd+shift+w!       & Close Window
\end{tabular}

\subsection{View Options}
\begin{tabular}{p{1.1in}  p{3in}}
\verb!cmd+alt+1!        & Normal one column layout \\
\verb!cmd+alt+2!        & Two column $\ldots$ upto 4 \\
\verb!cmd+alt+5!        & Grid view \\
\verb!cmd+alt+shift+2/3!        & 2 or 3 row view \\
\verb!cmd+ctrl+f!                  & Full screen view \\
\verb!shift+cmd+ctrl+f!        & toggle distraction view\\
\verb!ctrl+`!           & open console
\end{tabular}

\subsection{Move Cursor}
\begin{tabular}{p{1.1in}  p{3in}}
\verb!ctrl+shift+!$\uparrow$/ $\downarrow$            & Multi-cursor up (or down) \\
\verb!alt+!$\rightarrow$/ $\leftarrow$           & Move to next or previous word \\
\verb!ctrl+!$\rightarrow$/ $\leftarrow$           & Move to next or previous subword \\
...
\verb!cmd+alt+[\]! & Fold and unfold code.\\
...
\verb!cmd+i!            & Incremental Find \\
\verb!cmd+f!            & Find \\
\verb!cmd+g!               & Find next\\
\verb!cmd+shift+g!         & Find prev\\
\verb!alt+enter!        & Select all from within find\\
\verb!cmd+alt+f!            & Replace \\
\verb!cmd+alt+e!            & Replace next\\
\verb!cmd+shift+f!      & Find and replace in files \\
\verb!F4!            & Find next \\
\verb!shift+F4!      & Find previous \\
\verb!cmd+d!    & First time select word; Select this and next instance of word; Then select one more \ldots . Simultaneous edit possible.\\
\verb!ctrl+cmd+g!    & Select all instances of current word. Simultaneous edit possible.  \\
\verb!cmd+shift+space!            & Keep expanding scope\\
\verb!ctrl+shift+m!      & Select whole bracket \\
\verb!cmd+alt+r!        & toggle regex within find\\
\verb!cmd+alt+w!        & toggle whole word within find
...
\verb!cmd+[/]!         & indent/ unindent \\
\verb!tab!              & Indent selected \\
\verb!shift+tab!        & back indent selected \\
\verb!cmd+shift+p!     & Command Panel \\
\verb!cmd+y!           & repeat and not just redo \\
\verb!cmd+u!           & soft undo \\

\verb!cmd+/!           & comment/uncomment \\
\verb!cmd+shift+d!     & duplicate line below\\
\verb!cmd+j!           & join with line below
\end{tabular}

\subsection{Edit commands}
\label{Edit}
\begin{tabular}{p{1.1in}  p{3in}}
\verb!cmd+alt+q!               & Wrap selection (removes all new lines in selection) \\
\verb!cmd+k, cmd+u!               & Upper case \\
\verb!cmd+k, cmd+l!               & Lower case \\
